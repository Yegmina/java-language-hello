...
public class Car {
    ...
    public Car(double gasolinelevel, double speed) {
        System.out.println("initializer with gasolinelevel and speed is called");
        this.gasolineLevel = gasolinelevel;
        this.speed = speed;
        System.out.println("initializing complete, variables are: ");
        System.out.println("gasolinelevel: " + getGasolineLevel());
